            ...
            <div class="body">
                <form action="{{ route('income.update',$income->id) }}" method="POST">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="form-line" id="bs_datepicker_container">
                                <input type="date" class="form-control" placeholder="Please choose a date..." name="date" value="{{ $income->date }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="number" name="ammount" class="form-control" value="{{ $income->ammount }}" required>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="remarks" class="form-control" value="{{ $income->remarks }}">
                            </div>
                        </div>
                    </div>
                    <br>
